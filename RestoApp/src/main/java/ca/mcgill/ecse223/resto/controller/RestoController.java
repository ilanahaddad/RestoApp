...
public class RestoController {
	 ...
	 *            table to update
	 * @param newNumber
	 *            new table number to update to
	 * @param numberOfSeats
	 *            number of seats for updated table to have
	 * @throws InvalidInputException
	 *             if table doesn't exist, if newNumber and numberOfSeats aren't
	 ...
	 * @param numberInParty
	 *            number of people that are in the same reservation group
	 * @param contactName
	 *            name of the reservation client
	 * @param contactEmailAddress
	 *            e-mail
	 * @param contactPhoneNumber
	 *            phone number
	 * @param tables
	 *            list of tables of type Table
	 * @throws InvalidInputException
	 */
	 ...
	 *            the reservation that needs comparing to
	 * @param date
	 *            date of new reservation to be compared
	 * @param time
	 *            time of new reservation to be compared
	 * @return
	 */
	 ...
	 * 
	 * @param s
	 *            Seat do cancel order item for
	 * @param oi
	 *            orderItem to delete
	 * @throws InvalidInputException
	 *             if Seat is null, OrderItem is null, Seat has no OrderItems, and
	 ...
	 * 
	 * @param table
	 *            table to cancel order for
	 * @throws InvalidInputException
	 *             if table is null or if table isn't current
	 */
	 ...
	 * 
	 * @param menuItem
	 *            MenuItem to be added to order
	 * @param quantity
	 *            quantity of menuItem to be ordered
	 * @param seats
	 *            seats associated with the order
	 * @throws InvalidInputException
	 *             if menuItem or seats is null, seats list is empty, or quantity is
	 *             not positive
	 */
